# Generated by Django 4.2.1 on 2023-10-04 17:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_id', models.CharField(max_length=30)),
                ('movie_id', models.CharField(max_length=30)),
                ('play_time_before', models.CharField(default=None, max_length=30)),
                ('play_time_after', models.CharField(default=None, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_id', models.CharField(max_length=30)),
                ('movie_id', models.CharField(max_length=30)),
                ('play_time', models.CharField(default=None, max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Questionnaire',
